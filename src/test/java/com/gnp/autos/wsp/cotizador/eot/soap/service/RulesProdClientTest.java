...
public class RulesProdClientTest {
    ...
    public void getServiceWSPReqTest() {
        ServicioReglasAutosProductosRequest objReq = new ServicioReglasAutosProductosRequest();
        Integer tid = 245;
        String urlTInter = "";
        ServicioReglasAutosProductosResponse t = new ServicioReglasAutosProductosResponse();
        JAXBElement<ServicioReglasAutosProductosResponse> response = new ObjectFactory()
                .createServicioReglasAutosProductosResponse(t);
        when(webServiceTemplate.marshalSendAndReceive(any(JAXBElement.class), Matchers.any())).thenReturn(response);

        ServicioReglasAutosProductosResponse resp = client.getRulesProd(objReq, tid, urlTInter);
        assertNotNull(resp);
    ...
    public void getServiceExcWSPReqTest() throws XmlMappingException, IOException {
        ...
        client.getRulesProd(objReq, tid, urlTInter);
